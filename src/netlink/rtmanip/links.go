...
func (self *LinkHandler) Refresh() (err error) {
...
type LinkFinder interface {
	GetLinkByID(uint32) (*LinkHandler, error)
	GetLinkByName(string) (*LinkHandler, error)
	GetLinks() ([]*LinkHandler, error)
}
...
func (self *linkFinder) GetLinkByName(s string) (lh *LinkHandler, err error) {
